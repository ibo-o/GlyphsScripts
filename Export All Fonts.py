...
# I removed EOT file format. This script was originally written by Andreas Rasmussen 
...
for instance in font.instances:
    print("== Exporting Web ==")
    print(instance.generate(format=Web_OutlineFormat, fontPath=os.path.expanduser(subfolder_paths["WOFF"]), autoHint=TTF_AutoHint, removeOverlap=RemoveOverlap, useSubroutines=UseSubroutines, useProductionNames=UseProductionNames, containers=[WOFF, WOFF2]))
print()
